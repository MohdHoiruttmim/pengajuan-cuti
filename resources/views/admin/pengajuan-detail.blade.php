...
<main class="m-5">
  <div class="card bg-body-tertiary border">
    <div class="head d-flex text-body-secondary">
      <legend class="card-header">Data Pemohon</legend>
    </div>
    <form action="{{ route('admin-confirm-pengajuan') }}" class="my-3 mx-4" method="POST" enctype="multipart/form-data">
      @csrf
      <div class="row">
